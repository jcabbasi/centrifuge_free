...
NS=NumericalSetting(rk,20,0.001,1e-7,10,300,1e-10,simpleGridding=False)
DXv=NS.DXv
...
observed=LoadandSave.LoadDataFromExcel(filename,'B5','C170')

opt=GAoptimizer(OEOsim,rf,observed)

opt.OptimizeNowGA(simTime=[2000])
