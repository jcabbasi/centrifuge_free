...
#Pc SWW
# Pmax=0.16e5; Pmin=-0.10; Pmid=0.02e5
# rf.initializePc(2.0,30,Pmax,Pmin,Pmid,7,1)
...
simprops=simProps(0.25, [40],50000000) # inputs: inner radius (m), vector of omega (rad/s) , maximum simulation time (sec)

installation='OEO'

OEOsim=Simulate(simprops,rf,Init,NS,installation,printLog=False) 
pd.to_pickle(OEOsim,'newOEO_WW40.pickle')
res=OEOsim.simulateNow(FileName='newOEO_40_WW1712',InteractivePlot=True,reportPeriod=5)
